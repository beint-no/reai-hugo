param(
  [string]$SourceDir = "c:\\Users\\tahir\\Documents\\Desktop\\projects\\static-content-generator\\kontoplan",
  [string]$DestRoot = "c:\\Users\\tahir\\Documents\\Desktop\\projects\\rc\\content\\blog\\kontoplan"
)
...
Write-Host "Done. Imported kontoplan bundles to: $DestRoot"
