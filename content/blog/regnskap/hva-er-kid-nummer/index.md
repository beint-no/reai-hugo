...
summary: |
  En omfattende guide til KID-nummer (Kunde-IDentifikasjon) som forklarer hvordan dette norske betalingsreferansesystemet fungerer, de ulike typene KID-nummer, beregning av kontrollsiffer og praktisk anvendelse for automatisk avstemming av betalinger.
description: |
  Lær alt om KID-nummer (Kunde-IDentifikasjon) - hvordan det fungerer, ulike typer, beregning av kontrollsiffer og praktisk bruk i norsk betalingsformidling.
slug: hva-er-kid-nummer
featured_image: hva-er-kid-nummer-image.svg
featured_image_alt: "Hva er KID-nummer?"
url: "/blogs/regnskap/hva-er-kid-nummer/"
draft: false
---
