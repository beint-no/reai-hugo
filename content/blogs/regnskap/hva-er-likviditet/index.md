...
|-------|--------|----------|---------------|
| **Current Ratio** | Omløpsmidler Ã· Kortsiktig gjeld | Generell likviditet | 1,5 - 2,5 |
| **Quick Ratio** | (Omløpsmidler - Lager) Ã· Kortsiktig gjeld | Umiddelbar likviditet | 1,0 - 1,5 |
...
```
Current Ratio = Omløpsmidler Ã· Kortsiktig gjeld
```
...
```
Quick Ratio = (Omløpsmidler - Lagerbeholdning) Ã· Kortsiktig gjeld
```
...
| **DPO** | (Gjennomsnittlig leverandørgjeld Ã· Innkjøp) Ã— 365 | Dager til betaling |
