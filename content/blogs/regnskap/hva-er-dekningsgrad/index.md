...
seoTitle: "Dekningsgrad | Nøkkeltall for soliditet, likviditet og renter"
description: "Dekningsgrad er et samlebegrep for nøkkeltall som rentedekningsgrad, egenkapitalandel og likviditetsgrader. Lær formler, tolkning, bransjestandarder og forbedringstiltak."
summary: "Dekningsgrad forklart: typer, formler, tolkning og hvordan de brukes i analyse."
---
...
```
Rentedekningsgrad = Driftsresultat før renter og skatt (EBIT) Ã· Rentekostnader
```
...
![Sammenligning av likviditetsmål](likviditetsdekning-sammenligning.svg)

#### Likviditetsgrad 1 (Løpende likviditet):
```
Likviditetsgrad 1 = Omløpsmidler Ã· Kortsiktig gjeld
```

#### Likviditetsgrad 2 (Rask likviditet):
```
Likviditetsgrad 2 = (Omløpsmidler - Varelager) Ã· Kortsiktig gjeld
```
...
![Prosess for dekningsgradsanalyse](dekningsgradsanalyse-prosess.svg)
...
* **Varelageromløp** = Varekostnad Ã· Gjennomsnittlig varelager
...
* **Investeringsdekning** = Kontantstrøm fra drift Ã· Investeringer
...
* **Belåningsgrad** = Gjeld Ã· Markedsverdi eiendommer
...
![Rapporteringsstruktur for dekningsgrader](dekningsgrad-rapportering.svg)
...
![Digitale verktøy for dekningsgradsanalyse](digitale-verktoy-dekningsgrad.svg)
