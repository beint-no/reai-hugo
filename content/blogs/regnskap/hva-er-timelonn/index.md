...
**Basisformel:**
```
Bruttolønn = Timesats Ã— Arbeidede timer + Tillegg + Overtidscompensasjon
```
...
Total bruttolønn: (40 Ã— 200) + 600 = 8 600 kr
```
...
* Lønnskostnad per time Ã— Multiplikator = Salgspris per time
...
![timelonn-compliance-krav.svg](timelonn-compliance-krav.svg)
...
![timelonn-fremtid.svg](timelonn-fremtid.svg)
...
![timelonn-implementering.svg](timelonn-implementering.svg)
